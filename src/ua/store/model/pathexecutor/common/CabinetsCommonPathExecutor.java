 ...
 *
 */
public class CabinetsCommonPathExecutor implements PathExecutor, MyLogger {
	...
	public void executePath(HttpServletRequest request,
		...
		productMap.createProductMap(ProductType.CABINET);

		// set list to a request
		session.setAttribute("productMap", productMap);
		session.setAttribute("productType", ProductType.CABINET);
		
		// prepare jsp for forwarding
		String jspPage = "common/products.jsp";
		String title = "Cabinets";
		String message = "";
		ControllerHelper
