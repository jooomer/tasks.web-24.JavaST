 ...
 *
 */
public class TablesCommonPathExecutor implements PathExecutor, MyLogger {
	...
	public void executePath(HttpServletRequest request,
		...
		productMap.createProductMap(ProductType.TABLE);

		// set list to a request
		session.setAttribute("productMap", productMap);
		session.setAttribute("productType", ProductType.TABLE);
